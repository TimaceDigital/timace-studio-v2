...
exports.makeAdmin = exports.stripeWebhook = exports.createCheckoutSession = exports.createDraftOrder = exports.onUserCreate = void 0;
...
exports.createDraftOrder = functions.https.onCall(async (data, context) => {
    var _a;
    if (!context.auth) {
    ...
    const orderData = {
        ...
        title: ((_a = items[0]) === null || _a === void 0 ? void 0 : _a.name) || "New Project",
        items,
        configurations,
        notes,
        rawVision,
